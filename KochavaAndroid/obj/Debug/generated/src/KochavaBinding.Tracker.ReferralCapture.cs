...
namespace KochavaBinding.Tracker {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.kochava.android.tracker']/class[@name='ReferralCapture']"
	[global::Android.Runtime.Register ("com/kochava/android/tracker/ReferralCapture", DoNotGenerateAcw=true)]
	public partial class ReferralCapture : global::Android.Content.BroadcastReceiver {


		static IntPtr params_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.kochava.android.tracker']/class[@name='ReferralCapture']/field[@name='params']"
		[Register ("params")]
		public static string Params {
			get {
				if (params_jfieldId == IntPtr.Zero)
					params_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "params", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, params_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetStaticField (class_ref, params_jfieldId, native_value);
				} finally {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/kochava/android/tracker/ReferralCapture", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ReferralCapture); }
		}

		protected ReferralCapture (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.kochava.android.tracker']/class[@name='ReferralCapture']/constructor[@name='ReferralCapture' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ReferralCapture ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (ReferralCapture)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::KochavaBinding.Tracker.ReferralCapture __this = global::Java.Lang.Object.GetObject<global::KochavaBinding.Tracker.ReferralCapture> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.kochava.android.tracker']/class[@name='ReferralCapture']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
